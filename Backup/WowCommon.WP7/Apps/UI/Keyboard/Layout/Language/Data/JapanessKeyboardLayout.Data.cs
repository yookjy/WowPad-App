...
{
    partial class JapanessKeyboardLayout
    {
        public override List<KeyCap[]> GetKeyCapList()
        {
            ...
            keyCapList.Add(new KeyCap[]
            {
                ...
                new KeyCap() { KeyCapType = KeyCapTypes.LanguageSub, Text = "全角\n半角", KeyCode = 148 },
                new KeyCap() { KeyCapType = KeyCapTypes.LanguageSub, Text = "変換", KeyCode = 138 },
                new KeyCap() { KeyCapType = KeyCapTypes.LanguageSub, Text = "無変換", KeyCode = 139 },
                new KeyCap() { KeyCapType = KeyCapTypes.LanguageSub, Text = "カナ", KeyCode = 136 },
            ...
            keyCapList.Add(new KeyCap[]
            {
                ...
                new KeyCap() { Text = "ー", SubText = "-", KeyCode = 45 },
                new KeyCap() { KeyCapType = KeyCapTypes.Space, Text = "スペース", KeyCode = 44, IsHiddenToolTip = true, WidthRatio = 2 },
                new KeyCap() { Text = "、", SubText = "<", KeyCode = 54 },
                new KeyCap() { Text = "。", SubText = ">", KeyCode = 55 },
                new KeyCap() { KeyCapType = KeyCapTypes.Enter, Text = "改行", KeyCode = 40, IsHiddenToolTip = true, WidthRatio = 1.5 }
            });
